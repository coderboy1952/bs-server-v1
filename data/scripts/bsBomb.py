...
class BombFactory(object):
    ...
    def __init__(self):
        ...
        self.regularTex = bs.getTexture('logoEaster')
        self.iceTex = bs.getTexture('achievementFlawlessVictory')
        self.stickyTex = bs.getTexture('zoeColorMask')
        self.impactTex = bs.getTexture('egg3')
        self.impactLitTex = bs.getTexture('egg4')
        self.landMineTex = bs.getTexture('egg2')
        self.landMineLitTex = bs.getTexture('egg3')
